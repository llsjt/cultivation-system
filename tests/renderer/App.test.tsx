...
import type { GetEnumsOutput, GetHomeOverviewOutput, GetProjectCultivationOutput, GetProjectDetailOutput, IpcResult } from '../../src/shared/dto';
import type { CultivationAPI } from '../../src/shared/types/api';
import { normalizeProgressPercent } from '../../src/shared/progress';
import { App, ProgressBar } from '../../src/renderer/App';
...
function mockApi(): CultivationAPI {
  return {
    ...
    get_global_resources: vi.fn(() => Promise.resolve(ok({ items: [], total: 0 }))),
